...
BACKEND_DESCRIPTION="Rule-based K.R.O.T. backend with hybrid sing-box + zapret orchestration"
APP_DESCRIPTION="Rule-based K.R.O.T. LuCI app with hybrid sing-box + zapret orchestration"
