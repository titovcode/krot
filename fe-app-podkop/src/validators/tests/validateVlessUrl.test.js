...
const validUrls = [
  ...
  [
    'tcp without security (defaults to none)',
    'vless://94792286-7bbe-4f33-8b36-18d1bbf70723@127.0.0.1:34520?type=tcp&encryption=none#vless-tcp-no-security',
  ],
  // mKCP
  [
    'mKCP + none',
...
const invalidUrls = [
  ...
  [
    ...
    'vless://uuid@127.0.0.1:443?type=tcp&security=unknown',
  ],
  [
    'reality without pbk',
