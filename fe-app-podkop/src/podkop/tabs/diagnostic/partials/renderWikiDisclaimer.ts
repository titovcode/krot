import { renderGithubIcon24 } from '../../../../icons';
...
export function renderWikiDisclaimer(kind: 'default' | 'error' | 'warning') {
  ...
  iconWrap.appendChild(renderGithubIcon24());
  ...
  return E('div', { class: className }, [
    E('div', { class: 'pdk_diagnostic-page__right-bar__wiki__content' }, [
      ...
      E('div', { class: 'pdk_diagnostic-page__right-bar__wiki__texts' }, [
        E('b', {}, _('GitHub')),
        E('div', {}, _('Report issues, suggest features, or read the docs.')),
      ]),
    ]),
    renderButton({
      ...
      onClick: () =>
        window.open(
          'https://github.com/titovcode/krot#readme',
          '_blank',
          'noopener,noreferrer',
        ),
    }),
