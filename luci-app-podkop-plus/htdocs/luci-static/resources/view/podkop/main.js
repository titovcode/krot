...
function renderDefaultState({
  ...
  function renderSubscriptionDetails() {
    ...
    function renderLatency(outbound) {
      if (latencyRefreshRunning2) {
        return E(
          "span",
          { class: "pdk_dashboard-page__subscription-latency-loading" },
    ...
    function openSubscriptionModal() {
      ...
      async function refreshLatency(event) {
        ...
        try {
          ...
          replaceTable();
          const freshSection = await onTestLatency(currentSection.code, {
            force: true,
            quick: true
          });
          if (freshSection) {
            mergeFreshSectionPreservingOrder(freshSection);
          }
